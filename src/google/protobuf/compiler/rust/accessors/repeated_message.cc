...
void RepeatedMessage::InMsgImpl(Context<FieldDescriptor> field) const {
  ...
  field.Emit(
      ...
      pub fn r#$field$(&self) -> $pb$::RepeatedView<'_, $prefix$> {
        let inner = unsafe { $getter_thunk$(self.inner.msg, 
      ...
      pub fn r#$field$_mut(&mut self) -> $pb$::RepeatedMut<'_, $prefix$> {
          $pb$::RepeatedMut::from_inner($pbi$::Private, $pbr$::RepeatedFieldInner{ raw: unsafe { $getter_mut_thunk$(self.inner.msg, std::ptr::null(), self.inner.arena.raw())}, arena: &self.inner.arena} )
               ...
               field.Emit(R"rs(
      pub fn r#$field$(&self) -> $pb$::RepeatedView<'_, $prefix$> {
          $pb$::RepeatedView::from_inner($pbi$::Private, $pbr$::RepeatedFieldInner{ raw: unsafe { $getter_thunk$(self.inner.msg)}, _phantom: std::marker::PhantomData} )
      }
      pub fn r#$field$_mut(&mut self) -> $pb$::RepeatedMut<'_, $prefix$> {
