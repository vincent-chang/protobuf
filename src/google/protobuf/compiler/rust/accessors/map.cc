               ...
               [&] {
                 if (field.is_upb()) {
                   ...
                   field.Emit({}, R"rs(
                    pub fn r#$field$_mut(&mut self) -> $pb$::MapMut<'_, $Key$, $Value$> {
                      let inner = $pbr$::MapInner { 
                        raw: unsafe { $getter_thunk_mut$(self.inner.msg) },
                        _phantom: std::marker::PhantomData
                      };
                      $pb$::MapMut::from_inner($pbi$::Private, inner)
                    })rs");
           ...
           [&] {
             if (field.is_upb()) {
               ...
               field.Emit({}, R"rs(
                ...
                fn $getter_thunk_mut$(msg: $pbi$::RawMessage,) -> $pbi$::RawMap;
              )rs");
             }
           }},
      },
      ...
      {{"field", cpp::FieldName(&field.desc())},
       ...
       {"impls",
        [&] {
          field.Emit(
              R"cc(
                const google::protobuf::Map<$Key$, $Value$>& $getter_thunk$(
                    $QualifiedMsg$& msg) {
                  return msg.$field$();
                }
                google::protobuf::Map<$Key$, $Value$>* $getter_thunk_mut$($QualifiedMsg$* msg) {
